...
namespace Plugin.Bobisback.CombinedMods {
    public class PluginMain : CSharpPlugin, IEventListener {
        ...
        public override void OnLoad() {
            ...
            GUIManager.getInstance().gameObject.AddComponent(typeof(GUIWindowCreateInvasionMenu));
            ...
            GUIManager.getInstance().gameObject.AddComponent(typeof(GUIWindowSaveGameManager));
